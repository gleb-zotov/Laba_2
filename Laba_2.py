...
import os.path
check_file = os.path.isfile(r'D:\\Python.All\\Py.projects\\Laba_2.odt')
if check_file == 0:
    f = open(r'D:\\Python.All\\Py.projects\\Laba_2.odt', mode='w')
    f.close()
    f = open(r'D:\\Python.All\\Py.projects\\Laba_2.odt', mode='a+')
    Flag = '  \n'\
    ...
    f.write(Flag)
    f.close()
    f = open(r'D:\\Python.All\\Py.projects\\Laba_2.odt', mode='r')
